...
import { doUserPermissionAddExist, doUserPermissionUpdateExist, doUserPermissionDeleteExist } from '../../controller/users-permissions/convert'
...
export default class API {
  ...
  @Convert(doUserPermissionAddExist)
  ...
  @Required(['id'])
  @Convert(doUserPermissionUpdateExist)
  ...
  @Required(['id'])
  @Convert(doUserPermissionDeleteExist)
