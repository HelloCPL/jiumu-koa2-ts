...
export const doNovelAdd = async (ctx: Context, next: Next) => {
  ...
  const data = [getUuId(), params.name, params.introduce, params.classify, params.type, params.author, paramsData[0], paramsData[1], ctx.user.id, currentTime, currentTime, Terminal[ctx.terminal], params.remarks]
