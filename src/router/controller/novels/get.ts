...
export const getNovelList = async (options: NovelListParams): Promise<NovelListReturn> => {
  ...
  if (options.createUser) {
    ...
    orderSql = `t1.is_top DESC, like_count DESC, ${orderParams.orderSql}  collection_count DESC, t1.update_time DESC`
  }
